...
internal sealed class EventSample : MonoBehaviour
{
    ...
    {
        private readonly EEventGroup _group = new();

        internal EEventModule EmailEventModule;
        internal EEventModule LoginEventModule;
        ...
        internal void OnEnable()
        {
            ...
            _group.AddListener(LoginEventModule, EventId._13, AddCount3);
        }
    ...
    private sealed class ItemPanel
    {
        ...
        internal void OnEnable()
        {
            _group.AddListener<IEEventContext>(EmailEventModule, EventId._21, AddCount1);
        ...
        #region AddCount
        private void AddCount1(IEEventContext _) => ++count1;
        private void AddCount2(IEEventContext _) => ++count2;
        private void AddCount3() => ++count3;
        #endregion
    }
    #endregion
    ...
    #region EventContext
    private readonly struct StructContext : IEEventContext
    {
    ...
    private sealed class ClassContext : IEEventContext
    {
        internal readonly int Count;
    ...
    private readonly EEventModule _emailEventModule = new();
    private readonly EEventModule _loginEventModule = new();
    ...
    private void Update()
    {
        ...
        _emailEventModule.Dispatch(EventId._13);

        _loginEventModule.Enqueue(EventId._21, _context);
